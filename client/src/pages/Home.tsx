...
export default function Home() {
  ...
  return (
    <div className="relative w-screen h-screen bg-[#EDE7DC] text-black overflow-hidden">
      ...
      <div className="absolute bottom-[11vh] sm:bottom-[10vh] md:bottom-8 left-4 sm:left-5 md:left-8 z-50">
      ...
      <div className="absolute bottom-[11vh] sm:bottom-[10vh] md:bottom-8 right-4 sm:right-5 md:right-8 text-xs sm:text-sm text-gray-600 font-mono z-50">
        info@tzco.com
      </div>
