...
export default function Home() {
  ...
  return (
    <div className="relative w-screen h-screen bg-white text-black overflow-hidden">
      ...
      <div className="absolute bottom-[calc(env(safe-area-inset-bottom)+12vh+15px)] sm:bottom-[calc(5vh-30px)] md:bottom-[calc(32px-30px)] left-[-31px] sm:left-[-40px] md:left-[-28px] w-[154px] h-[154px] sm:w-[240px] sm:h-[240px] md:w-[288px] md:h-[288px] z-50">
        <Logo3D />
      </div>
      ...
      <div className="absolute top-[calc(50%-8vh)] sm:top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[84vw] h-[84vw] sm:w-[68vw] sm:h-[78vw] md:w-[468px] md:h-[468px] max-w-[84vh] max-h-[84vh] sm:max-w-[65vh] sm:max-h-[75vh] md:max-w-[468px] md:max-h-[468px] flex items-center justify-center z-10">
        <RandomParticle />
      </div>

      {/* Company Info - aligned with upper corner height */}
      <div className="absolute bottom-[calc(env(safe-area-inset-bottom)+12vh+10px)] sm:bottom-[5vh] md:bottom-8 left-4 sm:left-5 md:left-8 z-50 space-y-1 data-testid='company-info'">
      ...
      <div className="absolute bottom-[calc(env(safe-area-inset-bottom)+12vh+10px)] sm:bottom-[5vh] md:bottom-8 right-4 sm:right-5 md:right-8 z-50" data-testid="text-email">
