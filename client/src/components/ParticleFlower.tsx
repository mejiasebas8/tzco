      ...
      if (deltaTime >= frameInterval) {
        ...
        if (ctx) {
          particles.forEach(particle => {
            ...
            const flow = Math.sin(angle * 2 - timeRef.current * 0.676775 + height * 2) * 0.015;
            const counterFlow = Math.cos(angle * 2 + timeRef.current * 0.676775 - height * 2) * 0.015;
