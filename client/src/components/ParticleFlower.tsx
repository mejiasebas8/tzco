      ...
      if (deltaTime >= frameInterval) {
        ...
        if (ctx) {
          particles.forEach(particle => {
            ...
            const flow = Math.sin(angle * 2 - timeRef.current * 0.61525 + height * 2) * 0.015;
            const counterFlow = Math.cos(angle * 2 + timeRef.current * 0.61525 - height * 2) * 0.015;
            ...
            particle.z = particle.z + Math.sin(timeRef.current * 0.184575 + dist * 2) * 0.01;
